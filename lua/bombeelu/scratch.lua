...
function M.open(ft, method)
  ...
  vim.api.nvim_buf_set_option(scratchpad_buf_id, "filetype", ft)
  vim.api.nvim_buf_set_option(scratchpad_buf_id, "buftype", "acwrite")
  vim.api.nvim_buf_set_name(scratchpad_buf_id, "Scratch")
