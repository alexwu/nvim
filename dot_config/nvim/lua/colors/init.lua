...
M.set = function(theme)
  ...
  if success then M.set_colorscheme(colors, theme) end
end
...
M.set_colorscheme = function(hl, theme)
  ...
  if vim.g.syntax_on ~= nil then vim.cmd("syntax reset") end
  ...
  vim.g.terminal_ansi_colors = {
    special_grey.gui, red.gui, green.gui, yellow.gui, blue.gui, purple.gui,
    cyan.gui, white.gui, visual_grey.gui, dark_red.gui, dark_green.gui,
    dark_yellow.gui, dark_blue.gui, dark_purple.gui, dark_cyan.gui,
    comment_grey.gui
  }

  local function h(group, style)
    if not terminal_italics then
      if style.cterm == "italic" then style.cterm = nil end
      if style.gui == "italic" then style.gui = nil end
    end
    ...
    local hi =
      "highlight " .. group .. " guifg=" .. guifg .. " guibg=" .. guibg ..
        " guisp=" .. guisp .. " gui=" .. gui .. " ctermfg=" .. ctermfg ..
        " ctermbg=" .. ctermbg .. " cterm=" .. cterm

    vim.api.nvim_command(hi)
  end

  for _, t in ipairs({hl.common, hl.syntax, hl.ts, hl.lsp}) do
